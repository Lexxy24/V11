...
st2 =`YouTube Pembuat Sc\n${linkyt}\n𝑺𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝑭𝒐𝒓 𝑵𝒆𝒘 𝑼𝒑𝒅𝒂𝒕𝒆!`
but = [
{ buttonId: `${prefix}start`, buttonText: { displayText: '️𝘼𝙇𝙇 𝙈𝙀𝙉𝙐' }, type: 1 },
{ buttonId: `${prefix}scbot`, buttonText: { displayText: '️𝙎𝘾𝙍𝙄𝙋𝙏 𝘽𝙊𝙏' }, type: 1 }
]
...
{ buttonId: `${prefix}owner`, buttonText: { displayText: '️𝙊𝙒𝙉𝙀𝙍' }, type: 1 },
{ buttonId: `${prefix}donasi`, buttonText: { displayText: '️𝘿𝙊𝙉𝘼𝙎𝙄' }, type: 1 }
]
